...
function Actions({ isAllowed, onClick, isDisabled }) {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_UI_IconButton__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {
                src: isAllowed && !isDisabled ? _public_assets__WEBPACK_IMPORTED_MODULE_2__/* .check_active */ .Xv : _public_assets__WEBPACK_IMPORTED_MODULE_2__/* .check_disable */ .WA,
                disabled: isDisabled,
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_UI_IconButton__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {
                src: !isAllowed && !isDisabled ? _public_assets__WEBPACK_IMPORTED_MODULE_2__/* .cross_active */ .JE : _public_assets__WEBPACK_IMPORTED_MODULE_2__/* .cross_disable */ .QM,
                disabled: isDisabled,
                className: `relative h-[35px] w-[35px] mobile:w-[25px] mobile:h-[25px] ${isDisabled && "cursor-default"}`,
                onClick: ()=>{
                    if (isAllowed && !isDisabled) onClick();
...
function Input({ readOnly, name, onChange, value, type, pattern, className, currency = "$", isMonetaryInput = false }) {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: [
