...
const useMyGData = ()=>{
    ...
    const { personalData, setPersonalData, gData, rData, cData, screenData, compData, setCompData } = (0,_state_myGData_hooks__WEBPACK_IMPORTED_MODULE_5__/* .usePersonalData */ .h)();
    const { getAllConsentData, gTableColumns, updateMyGData, getAllPersonalData } = (0,_context_AppProvider__WEBPACK_IMPORTED_MODULE_8__/* .useApp */ .q)();
    const savePersonalData = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async (personal_data)=>{
        try {
            ...
            if (personal_data.photos) {
                ...
                await _config__WEBPACK_IMPORTED_MODULE_3__/* .api */ .h.post("api/personal_data_consents_rewards/file_upload", formData);
            }
            delete personal_data.photos;
            const payload = (0,_lib__WEBPACK_IMPORTED_MODULE_6__/* .createPayload */ .Z4)(personal_data);
            const { data } = await _config__WEBPACK_IMPORTED_MODULE_3__/* .api */ .h.post("api/personal_data_consents_rewards", payload);
    ...
    const updateConsentRewards = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async (arg)=>{
        ...
        try {
            setIsLoading(true);
            await _config__WEBPACK_IMPORTED_MODULE_3__/* .api */ .h.patch(`api/user_consents_rewards/${id}/`, payload);
            await getAllConsentData();
            await updateMyGData();
    ...
    const updateCompanyConsentRewards = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async (payload)=>{
        try {
            setIsLoading(true);
            const { data } = await _config__WEBPACK_IMPORTED_MODULE_3__/* .api */ .h.post("api/company_consents_rewards", payload);
    ...
    const savePersonalDataTemporarily = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((data)=>{
