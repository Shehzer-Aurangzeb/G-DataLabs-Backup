...
exports.modules = {
  /***/ 65807: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    const useMyGData = () => {
      ...
      _state_myGData_hooks__WEBPACK_IMPORTED_MODULE_4__ /* .usePersonalData */.h)();
      const { getAllConsentData, gTableColumns, updateMyGData, getAllPersonalData } = (0,
      _context_AppProvider__WEBPACK_IMPORTED_MODULE_7__ /* .useApp */.q)();
        ...
        async (personal_data) => {
          try {
            ...
            if (personal_data.photos) {
              ...
              await _config__WEBPACK_IMPORTED_MODULE_2__ /* .api */.h
