...
function Select({ className, options, style, value, onClick, increasePadding }) {
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        style: style,
        className: [
            `relative bg-chat dark:bg-darkChat dark:text-main ${increasePadding ?? "py-[10px]"} px-4 ${isOpen ? "rounded-md rounded-b-none" : "rounded-md"} w-full`,
            className
        ].join(" "),
        children: [
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_StyledImage__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
            ...
            isOpen && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("ul", {
                ...
                children: options.filter((item)=>item.value !== value).map((item)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("li", {
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            tabIndex: 0,
                            className: `cursor-pointer font-sans text-base font-normal text-primary dark:text-main  px-4 ${increasePadding ?? "py-[10px]"}`,
                            role: "button",
                            onClick: ()=>{
                                onClick(item.value);
                                toggleDropdown();
