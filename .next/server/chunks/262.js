...
exports.ids = [262];
exports.modules = {
  /***/ 91538: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
  ...
  /***/ 17076: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                                ...
                                style: {
                                  backgroundColor:
                                    theme === types /* Theme */.Q2.DARK
                                      ? constants /* SIDEBARLINKSCOLORS */.LQ.DARK[index]
                                      : constants /* SIDEBARLINKSCOLORS */.LQ.LIGHT[index],
                                },
                              }),
                              /*#__PURE__*/ jsx_runtime_.jsx('span', {
    ...
    function Sidebar() {
      ...
      const navItems = (0, react_.useMemo)(() => {
        if (!isAuthenticated || !user) return constants /* AUTHITEMS */.x1;
        if (user.accountType === constants /* ACCOUNTTYPE */.Z8.COMPANY)
          return constants /* APPITEMS */.a3
            .map((item) => {
              if (item.to === constants /* PATHS */.yy.MYGDATA && item.nestedItems) {
                return {
                  ...item,
                  nestedItems: [
                    ...item.nestedItems,
  ...
  /***/ 47721: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    'use strict';
    ...
    var logo = __webpack_require__(95600); // CONCATENATED MODULE: ./constants/assets.ts
  ...
  /***/ 70880: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    'use strict';
    /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      /* harmony export */ AJ: () => /* binding */ COMPANYTABLEDATA,
      ...
      /* harmony export */ EN: () => /* binding */ CONSENTTABLEDATA,
      ...
      /* harmony export */ LQ: () => /* binding */ SIDEBARLINKSCOLORS,
      ...
      /* harmony export */ rf: () => /* binding */ COMPANYTABLECOLUMNS,
    ...
    /* harmony import */ var _assets__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(47721);
    ...
    const APPITEMS = [
      {
        ...
        to: PATHS.HOME,
        icon_dark: _assets__WEBPACK_IMPORTED_MODULE_1__ /* .home_dark */.kP,
      },
      {
        title: 'History',
        icon: _assets__WEBPACK_IMPORTED_MODULE_1__ /* .history */.m8,
        to: PATHS.HISTORY,
        icon_dark: _assets__WEBPACK_IMPORTED_MODULE_1__ /* .history_dark */.nm,
      },
      {
        title: 'My G-Data',
        icon: _assets__WEBPACK_IMPORTED_MODULE_1__ /* .logo */.jY,
        icon_dark: _assets__WEBPACK_IMPORTED_MODULE_1__ /* .logo_dark */.J2,
        to: PATHS.MYGDATA,
        nestedItems: [
          {
            title: 'Personal Data',
      ...
      },
      {
        ...
        to: PATHS.ACCOUNT,
        icon_dark: _assets__WEBPACK_IMPORTED_MODULE_1__ /* .account_dark */.zE,
      },
    ];
  ...
  /***/ 66233: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    var useAuth = __webpack_require__(64260);
    // EXTERNAL MODULE: ./constants/index.ts
    var constants = __webpack_require__(70880); // CONCATENATED MODULE: ./context/AppProvider.tsx
    ...
    function AppProvider({ children }) {
      ...
      const getAllCompanyConsentData = (0, react_.useCallback)(async () => {
        try {
          if (!user || !user.accountType || user.accountType === constants /* ACCOUNTTYPE */.Z8.PERSONAL) return;
          const { data } = await config /* api */.h
      ...
      const getUserInfo = (0, react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async (token) => {
        ...
        const userInfo = {
          ...
          accountType: is_company
            ? _constants__WEBPACK_IMPORTED_MODULE_6__ /* .ACCOUNTTYPE */.Z8.COMPANY
            : _constants__WEBPACK_IMPORTED_MODULE_6__ /* .ACCOUNTTYPE */.Z8.PERSONAL,
        };
        return userInfo;
      }, []);
  ...
  /***/ 42257: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    /* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1___default =
      /*#__PURE__*/ __webpack_require__.n(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__);
    /* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(70880);

    const initialState = {
      personalData: {},
      gData: {},
      rData: {},
      cData: _constants__WEBPACK_IMPORTED_MODULE_0__ /* .CONSENTTABLEDATA */.EN,
      compData: _constants__WEBPACK_IMPORTED_MODULE_0__ /* .COMPANYTABLEDATA */.AJ,
      screenData: [],
    };
    const personalDataSlice = (0, _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.createSlice)({
      name: 'my_g_data',
      initialState,
      reducers: {
