...
const PersonalDataSchema = (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .object */ .Ry)({
    ...
    emotional_list: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .array */ .IX)().of((0,yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_)()),
    ...
    work_life_balance: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .number */ .Rx)().min(0, "Value must be at least 0").max(10, "Value must not exceed 10"),
