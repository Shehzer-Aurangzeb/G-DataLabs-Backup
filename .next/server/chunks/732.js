...
const PersonalInfoSchema = (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .object */ .Ry)({
    firstName: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_)().min(2, "First Name is too short").required("First Name is required"),
    lastName: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_)().min(2, "Last Name is too short").required("Last Name is required"),
    ...
    phone: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .mixed */ .nK)().test("is-phone-number", "Invalid phone number", (value)=>{
...
const PersonalDataSchema = (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .object */ .Ry)({
    ...
    high_temperature: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .number */ .Rx)().required("High Temperature is required"),
    low_temperature: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .number */ .Rx)().required("Low Temperature is required"),
    emotional_list: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .array */ .IX)().of((0,yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_)().required("Emotion List cannot be empty")).min(1, "At least one emotion is required"),
    emotional_overall: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_)().required("Overall emotion is required"),
    ...
    social_life_list: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .array */ .IX)().of((0,yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_)()),
...
const SignupFormSchema = (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .object */ .Ry)({
    ...
    lastName: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_)().min(2, "Last Name is too short").required("Last Name is required"),
    email: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_)().email().required("Email is required"),
    password: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_)().min(5, "Password must be 5 characters long").required("Password is required"),
    termsConditions: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .boolean */ .O7)().test("is-true", "You must accept the terms and conditions.", (value)=>value === true).required("Please accept the Terms and Conditions in order to proceed"),
    ...
    cookiePolicy: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .boolean */ .O7)().when([
        "privacyPolicy"
    ], {
        is: true,
        then: (schema)=>schema.oneOf([
...
const ConfirmPasswordFormSchema = (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .object */ .Ry)({
    ...
    password: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_)().required("Password is required"),
    confirm_password: (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_)().oneOf([
        (0,yup__WEBPACK_IMPORTED_MODULE_0__/* .ref */ .iH)("password"),
        ""
