...
exports.ids = [623];
exports.modules = {
  /***/ 11623: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    // ESM COMPAT FLAG
    ...
    var constants = __webpack_require__(70880); // CONCATENATED MODULE: ./components/screens/MyGData/ScreenData/Accordion/index.tsx
          ...
          children: [
            ...
            /*#__PURE__*/ (0, jsx_runtime_.jsxs)('div', {
              className: `px-3 transition-all duration-300 ${
                isOpen ? 'max-h-fit pb-6' : 'max-h-0 py-0'
              } overflow-hidden`,
              children: [
    ...
    /* harmony default export */ const ScreenData_Accordion = Accordion; // CONCATENATED MODULE: ./components/screens/MyGData/ScreenData/index.tsx
    ...
    function Main() {
      ...
      return /*#__PURE__*/ (0, jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
          /*#__PURE__*/ jsx_runtime_.jsx('h1', {
            className: `border-table border py-3 px-7 mobile:px-3 mobile:py-2 bg-table dark:bg-darkTable text-xl mobile:text-sm text-white font-medium font-sans whitespace-nowrap text-center max-w-[${
          ...
          /*#__PURE__*/ jsx_runtime_.jsx('div', {
            ...
            children: screenData.map((item) =>
              /*#__PURE__*/ jsx_runtime_.jsx(
                ScreenData_Accordion,
                {
                  data: item,
                },
                item.id,
