...
*/ function splitCookiesString(cookiesString) {
      ...
      function detectDomainLocale(domainItems, hostname, detectedLocale) {
        ...
        for (const item of domainItems) {
          ...
          const domainHostname =
            (_item_domain = item.domain) == null ? void 0 : _item_domain.split(':')[0].toLowerCase();
          if (
      ...
      var _edge_runtime_cookies = __webpack_require__(865); // CONCATENATED MODULE: ./node_modules/next/dist/esm/server/web/spec-extension/cookies.js
      ...
      const MIDDLEWARE_LOCATION_REGEXP =
        /* unused pure expression or super */ null && `(?:src/)?${MIDDLEWARE_FILENAME}`;
      // Pattern to detect instrumentation hooks file
      const INSTRUMENTATION_HOOK_FILENAME = 'instrumentation';
      const INSTRUMENTATION_HOOKS_LOCATION_REGEXP =
        /* unused pure expression or super */ null && `(?:src/)?${INSTRUMENTATION_HOOK_FILENAME}`;
      ...
      class MutableRequestCookiesAdapter {
        static wrap(cookies, onUpdateCookies) {
          ...
          const updateResponseCookies = () => {
            ...
            const staticGenerationAsyncStore =
              fetch.__nextGetStaticStore == null
                ? void 0
                : (_fetch___nextGetStaticStore = fetch.__nextGetStaticStore()) == null
                ? void 0
                : _fetch___nextGetStaticStore.getStore();
      ...
      class DraftModeProvider {
        constructor(previewProps, req, cookies, mutableCookies) {
          ...
          const cookieValue =
            (_cookies_get = cookies.get(COOKIE_NAME_PRERENDER_BYPASS)) == null ? void 0 : _cookies_get.value;
          this.isEnabled = Boolean(
            !isOnDemandRevalidate && cookieValue && previewProps && cookieValue === previewProps.previewModeId,
          );
            ...
            get mutableCookies() {
              if (!cache.mutableCookies) {
                cache.mutableCookies = getMutableCookies(
                  req.headers,
                  (renderOpts == null ? void 0 : renderOpts.onUpdateCookies) ||
      ...
      const adapter_FLIGHT_PARAMETERS = [[RSC], [NEXT_ROUTER_STATE_TREE], [NEXT_ROUTER_PREFETCH], [FETCH_CACHE_HEADER]];
      async function adapter(params) {
        await ensureInstrumentationRegistered();
        // TODO-APP: use explicit marker for this
        const isEdgeRendering = typeof self.__BUILD_MANIFEST !== 'undefined';
        const prerenderManifest =
          typeof self.__PRERENDER_MANIFEST === 'string' ? JSON.parse(self.__PRERENDER_MANIFEST) : undefined;
        ...
        if (response && rewrite) {
          ...
          if (
            isDataReq && // if the rewrite is external and external rewrite
      ...
      })(ResponseChoice || (ResponseChoice = {})); // CONCATENATED MODULE: ./public/assets/icons/home__icon.svg
      ...
      /* harmony default export */ const hidepassword_icon = {
        ...
        blurWidth: 8,
        blurHeight: 8,
      }; // CONCATENATED MODULE: ./public/assets/images/logo-dark.png
      ...
      var ResponseCookies = class {
        constructor(responseHeaders) {
          ...
          const setCookie = // @ts-expect-error See https://github.com/whatwg/fetch/issues/973
            (_c =
              (_b = (_a = responseHeaders.getAll) == null ? void 0 : _a.call(responseHeaders, 'set-cookie')) != null
                ? _b
