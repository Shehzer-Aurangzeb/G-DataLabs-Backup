...
;// CONCATENATED MODULE: ./constants/navigation.ts
const PATHS = {
    HOME: "/",
    HISTORY: "/history",
    MYGDATA: "/my_g-data",
...
async function middleware(request) {
    ...
    if (user) {
        ...
        if (!accountType && pathname === PATHS.COMPANY || accountType === ACCOUNTTYPE.PERSONAL && pathname === PATHS.COMPANY) {
    ...
    if ((pathname === PATHS.ACCOUNT || pathname === PATHS.COMPANY || pathname.includes(PATHS.MYGDATA) || pathname === PATHS.HISTORY || pathname === PATHS.OURGDATA) && !cookie) {
