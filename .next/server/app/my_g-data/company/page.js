...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 40923)), "/Users/shehzerabbasi/Downloads/Projects/G-Datalabs/App/app/my_g-data/company/page.tsx"],
...
;// CONCATENATED MODULE: ./components/screens/MyGData/Company/Table/index.tsx
...
function Table({ columns, data, updateConsentRewards }) {
    ...
    const handleConsetUpdate = (0,react_.useCallback)((name)=>{
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("thead", {
                children: headerGroups.map((headerGroup)=>/*#__PURE__*/ jsx_runtime_.jsx("tr", {
                        ...
                        children: headerGroup.headers.map((column)=>/*#__PURE__*/ jsx_runtime_.jsx("th", {
                                ...
                                className: `border-table dark:border-white border py-3 px-7 mobile:px-3 mobile:py-2 bg-table dark:bg-darkTable text-xl mobile:text-sm text-white font-medium font-sans whitespace-nowrap ${column.id === "fieldName" && "hidden"}`,
                ...
                children: rows.map((row)=>{
                  ...
                  `,
                                children: [
                                    ...
                                    cell.column.id === "Use" && /*#__PURE__*/ jsx_runtime_.jsx(components_Textarea, {
                                    ...
                                    cell.column.id === "Threshold" && /*#__PURE__*/ jsx_runtime_.jsx(Input/* default */.Z, {
...
/* harmony default export */ const Company_Table = (Table);

;// CONCATENATED MODULE: ./components/screens/MyGData/Company/index.tsx
...
function Main() {
    ...
    const tableData = (0,react_.useMemo)(()=>Object.entries(compData).map(([key, value])=>({
                PDataAndWeb: key,
                ...value
            })), [
        compData
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/shehzerabbasi/Downloads/Projects/G-Datalabs/App/components/screens/MyGData/Company/index.tsx`)
...
/* harmony default export */ const Company = (__default__);
;// CONCATENATED MODULE: ./app/my_g-data/company/page.tsx
