...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 46545)), "/Users/shehzerabbasi/Downloads/Projects/G-Datalabs/App/app/my_g-data/page.tsx"],
...
;// CONCATENATED MODULE: ./constants/my_g_data.ts
...
;// CONCATENATED MODULE: ./components/screens/MyGData/components/Table/index.tsx
                ...
                children: rows.map((row)=>{
                    ...
                    return /*#__PURE__*/ jsx_runtime_.jsx("tr", {
                        ...
                        children: row.cells.map((cell)=>/*#__PURE__*/ jsx_runtime_.jsx("td", {
                                ...
                                children: cell.column.id === "Consent" || cell.column.id === "Consent Value" || cell.column.id === "Rewards" || row.values.Consent !== "Photos" ? cell.render("Cell") : row.values[cell.column.id] && row.values[cell.column.id].length > 0 && row.values[cell.column.id].map(({ file_url })=>/*#__PURE__*/ jsx_runtime_.jsx(StyledImage/* default */.Z, {
                                        src: file_url,
                                        alt: "photo",
...
;// CONCATENATED MODULE: ./components/screens/MyGData/index.tsx
...
function Main() {
    ...
    const tableData = (0,react_.useMemo)(()=>Object.entries(gData).map(([key, value])=>({
                Consent: key,
                ...value
            })), [
        gData
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/shehzerabbasi/Downloads/Projects/G-Datalabs/App/components/screens/MyGData/index.tsx`)
...
/* harmony default export */ const MyGData = (__default__);
;// CONCATENATED MODULE: ./app/my_g-data/page.tsx
...
var __webpack_exports__ = __webpack_require__.X(0, [644,960,592,807,623], () => (__webpack_exec__(70268)));
