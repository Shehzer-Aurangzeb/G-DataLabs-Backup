...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 72613)), "/Users/shehzerabbasi/Downloads/Projects/G-Datalabs/App/app/my_g-data/consent/page.tsx"],
...
var lib_consent = __webpack_require__(73057);
;// CONCATENATED MODULE: ./components/screens/MyGData/Consent/Table/index.tsx
...
function Table({ columns, data, updateConsentRewards }) {
    ...
    const getCellValue = (0,react_.useCallback)((field, cellName)=>{
        ...
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("tbody", {
                ...
                children: rows.map((row)=>{
                  ...
                  `,
                                children: cell.column.id === "Consent" ? /*#__PURE__*/ jsx_runtime_.jsx(Actions/* default */.Z, {
                                ...
                                }) : cell.column.id === "Companies" && row.values.Companies.length > 0 ? /*#__PURE__*/ jsx_runtime_.jsx(Select/* default */.Z, {
                                ...
                                }) : cell.column.id === "Use" || cell.column.id === "Threshold" ? /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                    children: getCellValue(row.values.PDataAndWeb, cell.column.id.toLowerCase())
                                }) : cell.column.id === "Pricing" ? /*#__PURE__*/ jsx_runtime_.jsx(Input/* default */.Z, {
...
/* harmony default export */ const Consent_Table = (Table);

;// CONCATENATED MODULE: ./components/screens/MyGData/Consent/index.tsx
...
function Main() {
    ...
    const tableData = (0,react_.useMemo)(()=>Object.entries(cData).map(([key, value])=>({
                PDataAndWeb: key,
                ...value
            })), [
        cData
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/shehzerabbasi/Downloads/Projects/G-Datalabs/App/components/screens/MyGData/Consent/index.tsx`)
...
/* harmony default export */ const Consent = (__default__);
;// CONCATENATED MODULE: ./app/my_g-data/consent/page.tsx
...
var __webpack_exports__ = __webpack_require__.X(0, [644,960,592,807,54,94,473], () => (__webpack_exec__(81746)));
