...
;// CONCATENATED MODULE: ./lib/rewards.ts
                ...
                children: rows.map((row)=>{
                    ...
                    return /*#__PURE__*/ jsx_runtime_.jsx("tr", {
                        ...
                        children: row.cells.map((cell, cellIndex)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("td", {
                                ...cell.getCellProps(),
                                className: `border border-[#ced4da] py-6 px-7 mobile:p-3 dark:text-main text-black font-sans font-normal text-base mobile:text-sm text-center whitespace-nowrap ${cell.column.id === "id" && "hidden"} 
                
                  `,
                                children: [
                                    (cellIndex === 0 || cellIndex === 1) && cell.render("Cell"),
                                    cell.column.id === "Consent" && /*#__PURE__*/ jsx_runtime_.jsx(Actions/* default */.Z, {
                                        isAllowed: row.values.Consent !== "FALSE",
                                        isDisabled: row.values.id === null,
                                        onClick: ()=>updateConsentRewards({
                                                id: row.values.id,
                                                payload: {
                                    ...
                                    cell.column.id === "PDefinedValue" && /*#__PURE__*/ jsx_runtime_.jsx(Input/* default */.Z, {
                                    ...
                                    cell.column.id === "OtherCompValue" && /*#__PURE__*/ jsx_runtime_.jsx(Input/* default */.Z, {
...
var __webpack_exports__ = __webpack_require__.X(0, [644,960,592,807,54,94], () => (__webpack_exec__(25380)));
