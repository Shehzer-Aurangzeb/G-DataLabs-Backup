...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 49617)), "/Users/shehzerabbasi/Downloads/Projects/G-Datalabs/App/app/page.tsx"],
          
        }]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6182)), "/Users/shehzerabbasi/Downloads/Projects/G-Datalabs/App/app/layout.tsx"],
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 96330)), "/Users/shehzerabbasi/Downloads/Projects/G-Datalabs/App/app/loading.tsx"],
...
// EXTERNAL MODULE: ./components/UI/Containers/Side/index.tsx
var Side = __webpack_require__(86135);
...
function Container({ children, type, className = "", style }) {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            type === "side" && /*#__PURE__*/ jsx_runtime_.jsx(Side["default"], {
                className: `${className} dark:bg-main`,
                children: children
            })
        ]
...
;// CONCATENATED MODULE: ./components/screens/Home/MainContent/PromptInputBox/PromptResponseTypes/index.tsx
/* eslint-disable no-nested-ternary */ /* __next_internal_client_entry_do_not_use__ default auto */ 




function PromptResponseTypes({ selectedResponseType, setSelectedResponseType }) {
    const { theme } = (0,ThemeProvider/* useTheme */.F)();
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: "flex gap-x-3 ml-2 w-full mobile:flex-col ",
        children: constants/* PROMPTRESPONSEOPTIONS */.nz.map((option)=>/*#__PURE__*/ jsx_runtime_.jsx("button", {
                type: "button",
                ...
                style: {
                    backgroundColor: selectedResponseType === option.value ? theme === types/* Theme */.Q2.LIGHT ? option.color : option.darkColor : "transparent",
                    border: `2px solid ${theme === types/* Theme */.Q2.LIGHT ? option.color : option.darkColor}`,
                    borderTopWidth: "0px !important"
                },
                onClick: ()=>setSelectedResponseType(option),
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("p", {
                    className: `${selectedResponseType === option.value ? "text-white" : "text-primary dark:text-white"}  font-sans font-medium text-lg laptop:text-base text-center mobile:text-xs`,
                    children: [
                        " ",
                        option.title
                    ]
...
/* harmony default export */ const PromptInputBox_PromptResponseTypes = (PromptResponseTypes);

// EXTERNAL MODULE: ./components/UI/Loader/styles.css
var styles = __webpack_require__(38157);
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("span", {
                className: "absolute w-[5px] h-[5px] bg-[#3b5998] rounded-[50%] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("span", {
                className: "absolute w-[5px] h-[5px] bg-[#3b5998] rounded-[50%] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
            }),
...
;// CONCATENATED MODULE: ./components/screens/Home/MainContent/PromptInputBox/index.tsx
...
function PromptInputBox({ userPrompt, setUserPrompt, sendPrompt, isLoading }) {
    const handleResponseTypeChange = (responseType)=>{
        setUserPrompt({
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "flex items-center w-full pl-4 py-4 bg-chat border-main dark:bg-darkChat border rounded-xl relative textarea-container dark:border-white",
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx("button", {
                        ...
                        children: isLoading ? /*#__PURE__*/ jsx_runtime_.jsx(Loader_Loader, {}) : /*#__PURE__*/ jsx_runtime_.jsx(StyledImage/* default */.Z, {
                            src: assets/* send */.lW,
                            alt: "send-icon",
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(PromptInputBox_PromptResponseTypes, {
...
/* harmony default export */ const MainContent_PromptInputBox = (PromptInputBox);
...
/* harmony default export */ const images_logo = ({"src":"/_next/static/media/logo.542952fc.gif","height":700,"width":700,"blurWidth":0,"blurHeight":0});
;// CONCATENATED MODULE: ./lib/chats.ts
/* eslint-disable no-continue */ /* eslint-disable no-restricted-syntax */ const createChatsFeedbackState = (chats)=>{
    const results = {};
...
;// CONCATENATED MODULE: ./components/screens/Home/MainContent/ActiveChat/ChatActions/Tooltip/index.tsx


function Tooltip({ message, show }) {
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: `absolute top-[-25px] left-0 bg-main dark:bg-bgMain px-2 py-1 rounded-md ${show ? "opacity-1 visible" : "opacity-0 invisible"}`,
...
/* harmony default export */ const ChatActions_Tooltip = (Tooltip);

;// CONCATENATED MODULE: ./components/screens/Home/MainContent/ActiveChat/ChatActions/index.tsx
...
;// CONCATENATED MODULE: ./components/screens/Home/MainContent/ActiveChat/Loader/index.tsx



function ActiveChat_Loader_Loader() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: (styles_module_default()).loader,
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("span", {
                className: (styles_module_default()).typewriter,
                children: "..."
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("span", {
                className: (styles_module_default()).blink
            })
        ]
    });
}
/* harmony default export */ const ActiveChat_Loader = (ActiveChat_Loader_Loader);

;// CONCATENATED MODULE: ./components/screens/Home/MainContent/ActiveChat/Chat/index.tsx
...
function Chat({ isLoading = false, children, profile }) {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "bg-chat flex flex-row gap-x-8 items-center justify-start py-5 pl-8 pr-[120px] font-raleway text-primary text-xl font-semibold mb-4 mobile:px-2 mobile:text-base relative dark:bg-darkChat dark:text-main",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(StyledImage/* default */.Z, {
                src: profile,
                alt: "profile",
                className: "w-12 h-12 self-start min-w-[3rem]",
                rounded: true
            }),
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                children: [
                    isLoading && /*#__PURE__*/ jsx_runtime_.jsx(ActiveChat_Loader, {}),
                    children
                ]
            })
        ]
...
/* harmony default export */ const ActiveChat_Chat = (Chat);

;// CONCATENATED MODULE: ./components/screens/Home/MainContent/ActiveChat/index.tsx
...
function ActiveChat({ chats, userProfile, isLoggedIn, giveFeedback }) {
    ...
    const provideFeedback = (0,react_.useCallback)(async (payload)=>{
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        ref: messagesRef,
        children: chats.map((msg)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)(ActiveChat_Chat, {
                isLoading: msg.isLoading,
                profile: msg.isBotResponse ? profile(msg.isLoading) : userProfile,
                children: [
                    msg.content.text !== null && msg.content.text.length > 0 && msg.messageID !== chats[chats.length - 1].messageID && /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "whitespace-pre-line",
                        children: msg.content.text
                    }),
                    msg.content.text !== null && msg.content.text.length > 0 && msg.messageID === chats[chats.length - 1].messageID && /*#__PURE__*/ jsx_runtime_.jsx((react_typed_default()), {
                        strings: [
                            msg.content.text
                        ],
                        typeSpeed: 30,
                    ...
                    msg.content.images.length > 0 && /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "flex flex-row max-w-[60%] gap-2 flex-wrap mt-6  mobile:max-w-[70%] mobile:py-2 mobile:gap-0 dark:bg-darkChat",
                        children: msg.content.images.map((img)=>/*#__PURE__*/ jsx_runtime_.jsx(StyledImage/* default */.Z, {
                                src: img,
                                alt: "img",
                                className: "w-[150px] h-[160px] laptop:w-[120px] laptop:h-[130px] mobile:w-[95px] mobile:h-[100px]"
                            }, (0,v4/* default */.Z)()))
                    }),
                    isLoggedIn && msg.isBotResponse && /*#__PURE__*/ jsx_runtime_.jsx(ActiveChat_ChatActions, {
                        show: !msg.isLoading,
...
/* harmony default export */ const MainContent_ActiveChat = (/*#__PURE__*/(0,react_.memo)(ActiveChat));

;// CONCATENATED MODULE: ./components/screens/Home/MainContent/index.tsx
...
function MainContent({ user, userPrompt, sendPrompt, setUserPrompt, isLoading, chats, isAuthenticated, giveFeedback }) {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(Containers, {
        ...
        children: [
            ...
            chats && /*#__PURE__*/ jsx_runtime_.jsx(MainContent_ActiveChat, {
                chats: chats,
...
/* harmony default export */ const Home_MainContent = (MainContent);
...
;// CONCATENATED MODULE: ./components/screens/Home/SidePanel/ChatHistory/index.tsx





function ChatHistory({ groupedChatHistory, openPreviousChats }) {
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: "mt-8 flex flex-col gap-y-4 flex-1",
        children: Object.entries(groupedChatHistory).map(([key, value])=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)(react_.Fragment, {
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("p", {
                        className: "text-primary font-raleway font-semibold text-lg mt-2 dark:text-main",
                        children: key
                    }),
                    value.map((msg)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("button", {
                            type: "button",
...
/* harmony default export */ const SidePanel_ChatHistory = (/*#__PURE__*/(0,react_.memo)(ChatHistory));

;// CONCATENATED MODULE: ./components/screens/Home/SidePanel/index.tsx
...
function SidePanel({ isAuthenticated, recentChatHistory, openPreviousChats, newChat }) {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(Containers, {
        type: "side",
        ...
        children: [
            ...
            Object.keys(recentChatHistory).length > 0 ? /*#__PURE__*/ jsx_runtime_.jsx(SidePanel_ChatHistory, {
                groupedChatHistory: recentChatHistory,
                openPreviousChats: openPreviousChats
            }) : /*#__PURE__*/ jsx_runtime_.jsx(NoDataMessage/* default */.Z, {
                icon: assets/* no_chats */.PA,
                message: "No recent chats to display",
                isParentFixed: true
            }),
...
/* harmony default export */ const Home_SidePanel = (/*#__PURE__*/(0,react_.memo)(SidePanel));

;// CONCATENATED MODULE: ./components/screens/Home/index.tsx
...
function Home_Main() {
    const { user, isAuthenticated } = (0,useAuth/* useAuth */.a)();
    const { userPrompt, setUserPrompt, chats, fetchBotResponse, isLoading, recentChatHistory, openPreviousChats, startNewChat, provideResponseFeedback } = (0,useChatBot/* useChatBot */.L)();
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(Home_MainContent, {
                user: user,
                chats: chats,
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/shehzerabbasi/Downloads/Projects/G-Datalabs/App/components/screens/Home/index.tsx`)
...
/* harmony default export */ const Home = (__default__);
