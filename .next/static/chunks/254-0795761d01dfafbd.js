  ...
  [254],
  {
    ...
    1419: function (e, i, n) {
      ...
      var t = {
        ...
        T = { src: '/_next/static/media/edit__icon.0dee8109.svg', height: 25, width: 24, blurWidth: 0, blurHeight: 0 },
    ...
    7152: function (e, i, n) {
      ...
      let c = () => {
        let {
          ...
          U = (0, r.useCallback)(
            (e) => {
              _(e.id), e.messages.length > 0 && l((0, s.NI)(e.messages));
            },
            [l, _],
          );
        return {
    ...
    5531: function (e, i, n) {
      ...
      var t = n(7373),
        ...
        h = n(8421),
        f = n(54);
      let g = (0, t.UY)({ user: d.Z, loading: l.Z, my_g_data: u.ZP, chats: A.ZP, sidebar: h.Z, weather: f.Z }),
        m = { key: 'root', storage: c.Z, blacklist: ['loading', 'user', 'chats', 'my_g_data'] },
        E = (0, a.OJ)(m, g),
        C = (0, r.xC)({ reducer: E, middleware: [s.Z] });
      (i.ZP = C), (0, a.p5)(C);
      let _ = o.I0;
    },
    8557: function (e, i, n) {
