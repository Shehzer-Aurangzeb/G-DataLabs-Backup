        ...
        let { isLoading: e, setIsLoading: t } = (0, i.r)(),
          ...
          y = (0, r.useCallback)(async (e) => {
            ...
            let p = {
              ...
              totalRewards: s,
              key: '',
              accountType: c ? d.Z8.COMPANY : d.Z8.PERSONAL,
            };
            return p;
          }, []),
          C = (0, r.useCallback)(
            async (e) => {
              ...
              try {
                ...
                a({ user: i, isAuthenticated: !0 }), g.replace(c.y.HOME), o.toast.success('Welcome to G-Data Labs');
              } catch (e) {
                e instanceof s.d7
          ...
          v = (0, r.useCallback)(
            async (e) => {
              try {
                ...
                o.toast.success('Your account has been successfully created'), g.replace(c.y.LOGIN);
              } catch (e) {
                o.toast.error('Something went wrong');
              } finally {
                t(!1);
          ...
          D = (0, r.useCallback)(
            async (e) => {
              try {
                ...
                o.toast.success(a.message), g.push(c.y.CONFIRMPASSWORD);
              } catch (e) {
                var a;
                e instanceof s.d7
          ...
          N = (0, r.useCallback)(
            async (e) => {
              try {
                ...
                o.toast.success(a.message), g.push(c.y.LOGIN);
              } catch (e) {
                var a;
                e instanceof s.d7
                  ? o.toast.error(null === (a = e.response) || void 0 === a ? void 0 : a.data.error)
          ...
          R = (0, r.useCallback)(() => {
            a({ user: void 0, isAuthenticated: !1 }), h(), o.toast.success('Logout Successful.'), g.replace(c.y.LOGIN);
          }, [a, g, h]);
        return {
          loginUser: C,
          logoutUser: R,
    ...
    1515: function (e, t, a) {
      ...
      let u = (e, t, a) => {
        ...
        p = (e) => {
          ...
          if (t === s.me.RData)
            for (let e of a) {
              let t = c(e.field_name.toLowerCase().replaceAll('_', ' '));
              r[t] = {
                ...r[t],
