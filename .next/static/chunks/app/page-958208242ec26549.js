      ...
      var b = function () {
                ...
                (0, r.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, r.jsx)('button', {
                      ...
                      children: i
                        ? (0, r.jsx)(b, {})
                        : (0, r.jsx)(u.Z, { src: p.lW, alt: 'send-icon', className: 'w-[40px] h-[40px] dark:invert' }),
                    }),
                  ],
                }),
                (0, r.jsx)(m, {
        ...
        _ = function (e) {
          ...
          return (0, r.jsxs)('div', {
            ...
            children: [
              (0, r.jsx)(u.Z, { src: o, alt: 'profile', className: 'w-12 h-12 self-start min-w-[3rem]', rounded: !0 }),
        ...
        R = function (e) {
          ...
          return (0, r.jsxs)(c, {
            type: 'main',
            children: [
              i && (0, r.jsx)(I, { chats: i, userProfile: t ? t.image : p.oB, isLoggedIn: l, giveFeedback: u }),
      ...
      function B() {
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
            ...
            (0, r.jsx)(M, { isAuthenticated: t, recentChatHistory: u, openPreviousChats: p, newChat: f }),
          ],
        });
      }
    },
      ...
      let p = () => {
        let { isLoading: e, setIsLoading: t } = (0, i.r)(),
          ...
          T = (0, r.useCallback)(async () => {
            try {
              let e = (0, c.P4)({ isBotResponse: !1, isLoading: !1, text: p.data, images: [] }),
                n = (0, c.P4)({ isBotResponse: !0, isLoading: !0, text: '', images: [] });
              d(e), d(n), t(!0), y();
              let r = v;
