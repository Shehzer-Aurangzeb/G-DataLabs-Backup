        ...
        f = () => {
          let { isLoading: e, setIsLoading: t } = (0, i.r)(),
            ...
            N = (0, r.useCallback)(async () => {
              try {
                let e = (0, c.P4)({ isBotResponse: !1, isLoading: !1, text: f.data, images: [] }),
                  n = (0, c.P4)({ isBotResponse: !0, isLoading: !0, text: '', images: [] });
                y(e), y(n), t(!0), h();
                let r = x;
                C && !r && (r = await P(f.data));
                let o = C ? { ...f, chat_id: r } : f,
                ...
                s.images &&
                  ...
                  s.response.length && (l = s.response),
                  m({ ...n, isLoading: !1, content: { text: l, images: i } }, s.id),
                  C && (S(), O());
              } catch (t) {
                var e;
                t instanceof s.d7
