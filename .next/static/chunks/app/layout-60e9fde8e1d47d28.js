          ...
          g = (0, s.useCallback)(
            async (e) => {
              ...
              try {
                ...
                let { data: l } = await i.h.patch('api/user_profile/1/', r),
                  { profile_picture_url: o } = l.data;
                o || (o = (0, u.El)(l.data.first_name));
                let c = {
                  ...f,
                  firstName: l.data.first_name,
                  lastName: l.data.last_name,
                  phoneNumber: l.data.phone_number,
                  totalRewards: null !== (s = l.data.total_rewards) && void 0 !== s ? s : 0,
                  email: l.data.email,
                  image: o,
                ...
                a({ user: c, isAuthenticated: !0 }), n.toast.success('Personal information updated successfully');
              } catch (e) {
                e instanceof l.d7
                  ? n.toast.error(null === (r = e.response) || void 0 === r ? void 0 : r.data.error)
                  : n.toast.error('Something went wrong ');
