      ...
      var p = a(9699),
        m = function (e) {
          let { columns: t, data: a, updateConsentRewards: s } = e,
            ...
            [x, h] = (0, n.useState)(u(a)),
            [b, w] = (0, n.useState)(''),
            v = (e) => {
              let { value: t, name: a } = e.target;
              if (!/^\d*\.?\d*$/.test(t)) return;
              let l = a.split('-')[0];
              h((e) => ({ ...e, [l]: { ...e[l], demanded_reward_value: t } })), w(l);
            };
          return (
            (0, n.useEffect)(() => {
              let e = setTimeout(() => {
                              ...
                              children: [
                                ...
                                'PDefinedValue' === t.column.id &&
                                  (0, l.jsx)(p.Z, {
                                    ...
                                    isMonetaryInput: !0,
                                    value: x[e.values.PDataAndScreen].demanded_reward_value,
                                    onChange: v,
                                  }),
    ...
    6571: function (e, t, a) {
      ...
      let m = () => {
        let { isLoading: e, setIsLoading: t } = (0, i.r)(),
          ...
          { getAllConsentData: v, gTableColumns: _, updateMyGData: j, getAllPersonalData: g } = (0, p.q)(),
          y = (0, l.useCallback)(
            async (e) => {
              try {
                if ((t(!0), e.photos)) {
          ...
          C = (0, l.useCallback)(
            async (e) => {
              try {
                ...
                w(l), n.toast.success('Consent updated');
              } catch (e) {
                n.toast.error('Some problem updating consent');
              } finally {
                t(!1);
