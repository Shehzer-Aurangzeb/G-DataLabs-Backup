      ...
      var l = a(7437),
            ...
            (0, s.useEffect)(() => {
              let e = setTimeout(() => {
                b &&
                  (n([
                    {
                      demanded_reward_value: Number(x[b].pricing),
                      usage: x[b].use,
                      threshold: Number(x[b].threshold),
                              ...
                              children: [
                                ...
                                3 === a &&
                                  (0, l.jsx)(u.Z, {
                                    ...
                                    type: 'text',
                                    value: x[e.values.fieldName] ? x[e.values.fieldName].use : '',
                                    onChange: (e) => v(e, 'use'),
                                ...
                                4 === a &&
                                  (0, l.jsx)(u.Z, {
                                    ...
                                    isMonetaryInput: !0,
                                    pattern: '\\d*\\.?\\d*',
                                    value: x[e.values.fieldName] ? x[e.values.fieldName].pricing : '',
                                    onChange: (e) => v(e, 'pricing'),
                                    className: 'min-w-[160px]',
                                  }),
                                5 === a &&
                                  (0, l.jsx)(u.Z, {
                                    ...
                                    type: 'text',
                                    pattern: '\\d*\\.?\\d*',
                                    value: x[e.values.fieldName] ? x[e.values.fieldName].threshold : '',
                                    onChange: (e) => v(e, 'threshold'),
                                    className: 'min-w-[160px]',
                                  }),
                              ],
                            },
        ...
        f = function () {
          ...
          return (0, l.jsxs)('div', {
            ...
            children: [
              (0, l.jsx)(p, { data: a, columns: r.r, updateConsentRewards: t }),
