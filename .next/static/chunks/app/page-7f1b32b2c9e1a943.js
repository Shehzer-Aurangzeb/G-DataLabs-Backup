(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [931],
  {
      ...
      var h = function () {
        ...
        _ = function (e) {
          ...
          return (0, r.jsxs)(u, {
            type: 'main',
            children: [
              i && (0, r.jsx)(P, { chats: i, userProfile: t ? t.image : p.oB, isLoggedIn: l }),
    ...
    6171: function (e, t, n) {
      ...
      var r = n(9222),
        o = n(6022);
      let a = r.default.create({ baseURL: 'https://api.g-datalabs.com/' });
          ...
          v = (0, r.useCallback)(
            async (e) => {
              ...
              try {
                t(!0);
                let o = new FormData();
                for (let [t, n] of Object.entries(e)) o.append(t, n);
                let { data: s } = await i.h.patch('api/user_profile/1/', o),
                  { profile_picture_url: l } = s.data;
                l || (l = (0, p.El)(s.data.first_name));
                let u = {
                  ...y,
                ...
                n({ user: u, isAuthenticated: !0 }), a.toast.success('Personal information updated successfully');
              } catch (e) {
                e instanceof s.d7
                  ? a.toast.error(null === (o = e.response) || void 0 === o ? void 0 : o.data.error)
                  : a.toast.error('Something went wrong ');
      ...
      let l = (e, t, n) => {
        ...
        c = (e) => {
          let t = e.split(' ').filter((e) => e.length > 0),
            n = '';
          return t.length > 0 && (n = t.map((e) => e[0].toUpperCase() + e.slice(1, e.length)).join(' ')), n;
        },
        p = (e) =>
        ...
        d = (e) => {
          ...
          if (t === s.me.PData)
            for (let e of n) {
              let t = o()(e.created_at).format('YYYY-MM-DD'),
          ...
          if (t === s.me.GData)
            for (let e of n) {
              ...
              for (let n of e.values) {
                let e = o()(n.created_at).format('YYYY-MM-DD');
                r[t] = { ...r[t], [e]: 'Photos' === t ? n.files.map((e) => e) : n.value };
              }
              r[t] = {
                ...r[t],
        ...
        y = (e) => {
          ...
          let r = e[n].values
            .map((e) => o()(e.created_at).format('YYYY-MM-DD'))
        ...
        v = (e) =>
          e.map((e) => {
            let t = [],
              n = e.history.sort((e, t) => (o()(e.timestamp).isAfter(o()(t.timestamp)) ? 1 : -1));
            for (let e of n) {
              let n = f({
                  text: e.answer,
            ...
            return { title: e.name, date: o()(e.created_at).format('YYYY-MM-DD HH:mm:ss'), id: e.id, messages: t };
          });
    },
    7445: function (e, t, n) {
      'use strict';
