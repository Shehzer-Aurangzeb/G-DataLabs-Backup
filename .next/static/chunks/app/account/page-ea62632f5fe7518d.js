(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [346],
  {
    7769: function (e, a, t) {
      Promise.resolve().then(t.bind(t, 8390)),
        ...
        Promise.resolve().then(t.bind(t, 4344));
    },
    446: function (e, a, t) {
      'use strict';
      var l = t(7437);
    ...
    4344: function (e, a, t) {
      ...
      let p = () => {
        let [e, a] = (0, r.useState)(!1),
          [t, l] = (0, r.useState)(''),
          { setUser: s, user: n } = (0, x.a)(),
          o = (0, r.useCallback)(
            async (e) => {
              try {
                var t;
                a(!0);
                let { data: r } = await m.h.post('api/user_profile/add_and_verify_bank', e);
                n &&
                  s({
                    user: {
                      ...n,
          ...
          { ready: i, open: c } = (0, u.usePlaidLink)({
            token: t,
            onSuccess: (e, a) => {
          ...
          d = (0, r.useCallback)(async () => {
            try {
              a(!0);
              let { data: e } = await m.h.get('api/plaid/link_token');
              l(e.data.link_token);
            } catch (e) {
            } finally {
              a(!1);
      ...
      var f = function (e) {
          ...
          return (0, l.jsxs)('div', {
            ...
            children: [
              ...
              (0, l.jsxs)('div', {
                ...
                children: [
                  (0, l.jsx)(h.Z, {
                    src: 0 === t.length ? b.oB : t,
                    alt: 'profile',
                    className: 'w-[50px] h-[50px]',
                    rounded: !0,
                  }),
                  (0, l.jsx)(h.Z, { src: b.ws, alt: 'upload-icon', className: 'w-[36px] h-[36px]  dark:invert' }),
                  (0, l.jsx)('p', {
        ...
        N = function (e) {
          var a;
          let { user: t, updateUser: s, isLoading: u } = e,
            [m, x] = (0, r.useState)(null),
            [h, b] = (0, r.useState)(null !== (a = t.image) && void 0 !== a ? a : ''),
            { getPlaidLinkToken: N, isLoading: k } = p(),
            {
              ...
              initialValues: { ...n.KV, ...t, phone: t.phoneNumber },
          ...
          return (0, l.jsx)('form', {
            ...
            children: (0, l.jsxs)('div', {
              ...
              children: [
                ...
                (t.accountNo || t.accountTitle || t.bankName) && (0, l.jsx)(f, { values: v, touched: g, errors: j }),
                (0, l.jsxs)('div', {
                  className:
        ...
        k = (0, r.memo)(function () {
          ...
          return (0, l.jsxs)('div', {
            ...
            children: [
              ...
              e && (0, l.jsx)(N, { user: e, updateUser: a, isLoading: t }),
            ],
          });
        });
    },
  ...
  function (e) {
    e.O(0, [986, 139, 16, 842, 905, 707, 100, 971, 596, 744], function () {
      return e((e.s = 7769));
    }),
      (_N_E = e.O());
  },
