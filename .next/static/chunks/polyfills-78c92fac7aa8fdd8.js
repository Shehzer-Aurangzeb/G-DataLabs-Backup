!(function () {
    ...
    { target: 'Array', proto: !0 },
    {
      flatMap: function (t) {
        var e,
          ...
          n = ft(r.length);
        return (
          ee(t), ((e = ue(r, 0)).length = Ae(e, r, r, n, 0, 1, t, arguments.length > 1 ? arguments[1] : void 0)), e
        );
      },
    },
  ),
          ...
          u = function (t, e, r) {
            ...
            return (
              c
                ? (c.value = r)
                : ((u.last = c =
                    { index: (o = $r(e, !0)), key: e, value: r, previous: (n = u.last), next: void 0, removed: !1 }),
                  u.first || (u.first = c),
                  n && (n.next = c),
                  i ? u.size++ : t.size++,
                  'F' !== o && (u.index[o] = c)),
        ...
        [
          ...
          function (t, o) {
            ...
            var a = j(t),
              ...
              f = new s(
                Qi ? a : '^(?:' + a.source + ')',
                (a.ignoreCase ? 'i' : '') + (a.multiline ? 'm' : '') + (a.unicode ? 'u' : '') + (Qi ? 'y' : 'g'),
              ),
              l = void 0 === o ? Ji : o >>> 0;
            if (0 === l) return [];
  ...
  var bu =
    ...
    Su = function (t) {
      return function (e, r, n) {
        ...
        return c <= u || '' == s
          ? a
          : ((i = bu.call(s, wu((o = c - u) / s.length))).length > o && (i = i.slice(0, o)), t ? a + i : i + a);
      };
    },
        ...
        if (y(c))
          if ('function' == typeof (t = vr(c)))
            for (r = (e = t.call(c)).next; !(n = r.call(e)).done; ) {
              if ((a = (i = (o = cn(j(n.value))).next).call(o)).done || (u = i.call(o)).done || !i.call(o).done)
  ...
  var Ss,
        ...
        switch (((i = o[f]), c)) {
          ...
          case cc:
            if (i && (_s.test(i) || '+' == i || '-' == i || '.' == i)) l += i.toLowerCase();
              ...
              if (
                r &&
                (ec(t) != w(tc, l) || ('file' == l && (rc(t) || null !== t.port)) || ('file' == t.scheme && !t.host))
              )
                return;
          ...
          case jc:
            r || '#' != i
              ? i != Ss && ("'" == i && ec(t) ? (t.query += '%27') : (t.query += '#' == i ? '%23' : Zs(i, Xs)))
              : ((t.fragment = ''), (c = Pc));
            break;
          case Pc:
    ...
    Lc = function () {
      ...
      return (
        null !== o
          ? ((c += '//'), rc(t) && (c += r + (n ? ':' + n : '') + '@'), (c += Hs(o)), null !== i && (c += ':' + i))
          : 'file' == e && (c += '//'),
  ...
  (Zc && tf) ||
    ...
    'process' == h(ef)
      ...
      : !n.addEventListener || 'function' != typeof postMessage || n.importScripts || o(lf) || 'file:' === Qc.protocol
      ? (Vc =
          uf in x('script')
            ? function (t) {
  ...
  var If,
    ...
    ol = function (t, e, r) {
      var o, i;
      Qf
        ? (((o = $f.createEvent('Event')).promise = e), (o.reason = r), o.initEvent(t, !1, !0), n.dispatchEvent(o))
  ...
  tl &&
    ...
    ((If = function (t) {
      zf(this, { type: Df, done: !1, notified: !1, parent: !1, reactions: [], rejection: !1, state: 0, value: void 0 });
        ...
        (this._bodyInit = t),
          t
            ? 'string' == typeof t
              ...
              ? ((this._bodyArrayBuffer = Tl(t.buffer)), (this._bodyInit = new Blob([this._bodyArrayBuffer])))
