...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [289],
  {
    6171: function (e, t, a) {
      ...
      var n = a(9222),
        r = a(6022);
      let l = n.default.create({ baseURL: 'https://api.g-datalabs.com/' });
      ...
      var C = function (e) {
        ...
        let v = (0, r.useCallback)(async () => {
          ...
          k = (0, r.useCallback)(async () => {
            ...
            let a = (0, o.Yn)(e);
            console.log('GData columns', a), console.log('GData ', t), D(a), c(t);
          }, [c]),
          ...
          E = (0, r.useMemo)(
            () => ({ gTableColumns: y, getAllConsentData: w, updateMyGData: k, getAllPersonalData: v }),
            [y, w, k, v],
          );
        return (
          (0, r.useEffect)(() => {
          ...
          (0, n.jsx)(g.Provider, { value: E, children: t })
        );
      };
    },
    7999: function (e, t, a) {
          ...
          e.map((e) => {
            ...
            for (let e of a) {
              let a = f({
                ...
                n = f({ text: e.question, images: [], isBotResponse: !1, isLoading: !1 });
              t.push(n), t.push(a);
            }
